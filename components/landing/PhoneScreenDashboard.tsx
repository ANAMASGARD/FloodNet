    ...
    <div className="h-full w-full flex flex-col px-4 py-2 text-white text-[10px] leading-tight font-sans">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-head text-[11px] tracking-wide">MEDI DEV</span>
        </div>
      ...
      <p className="font-head text-[13px] mb-3">Dr. Sarah Chen</p>
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl p-3 mb-2.5">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-green-400 text-[9px] font-medium">Normal</span>
        </div>
        {/* Sparkline */}
      ...
      <div className="grid grid-cols-3 gap-1.5 mt-auto">
        {[
          { icon: Activity, label: "Vitals", color: "text-red-400" },
          { icon: Heart, label: "Records", color: "text-orange-400" },
          { icon: Shield, label: "Reports", color: "text-blue-400" },
